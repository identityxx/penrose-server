...
"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -Djava.ext.dirs="%LOCALLIBPATH%" -Djavax.management.builder.initial=mx4j.server.MX4JMBeanServerBuilder -Dpenrose.home="%PENROSE_HOME%" org.safehaus.penrose.PenroseServer %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
