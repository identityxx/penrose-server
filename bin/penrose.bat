...
"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -classpath "%LOCALCLASSPATH%" -Dpenrose.home="%PENROSE_HOME%" org.apache.ldap.server.ServerMain "%PENROSE_HOME%\conf\apacheds.properties" %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
