...
"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -classpath "%LOCALCLASSPATH%" -Dpenrose.home="%PENROSE_HOME%" org.safehaus.penrose.PenroseServer "%PENROSE_HOME%\conf\apacheds.xml" %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
