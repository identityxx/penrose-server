...
public class InterpreterManager {
    ...
    public Interpreter newInstance() throws Exception {
        return newInstance("DEFAULT");
    }

    public Interpreter newInstance(String name) throws Exception {
        InterpreterConfig interpreterConfig = (InterpreterConfig)interpreters.get(name);
