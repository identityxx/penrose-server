package org.safehaus.penrose.nis.tools;
...
public class NISLDAPSyncTool {

    public static Logger log = Logger.getLogger(NISLDAPSyncTool.class);

    PenroseClient client;

    public NISLDAPSyncTool(
            String serverType,
            String protocol,
            String hostname,
            int port,
    ...
    public static void showUsage() {
        System.out.println("Usage: org.safehaus.penrose.nis.tools.NISLDAPSyncTool [OPTION]... <command> [arguments]...");
        System.out.println();
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            NISLDAPSyncTool client = new NISLDAPSyncTool(
                    serverType,
                    protocol,
                    hostname,
                    portNumber,
