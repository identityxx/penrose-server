 ...
 */
public class SearchBasicTest extends BasicTestCase {

    public SearchBasicTest() throws Exception {
    }
    ...
    public void testSearchingEmptyDatabase() throws Exception {
        ...
        session.search("ou=Groups,dc=Example,dc=com", "(objectClass=*)", sc, results);
    ...
    public void testSearchingOneLevel() throws Exception {
        ...
        for (int i=0; i<groupnames.length; i++) {
            ...
            assertEquals(dn, "cn="+groupnames[i]+",ou=Groups,dc=Example,dc=com");

            Attributes attributes = sr.getAttributes();
            Attribute attribute = attributes.get("cn");
            assertEquals(attribute.get(), groupnames[i]);
            attribute = attributes.get("description");
            assertEquals(attribute.get(), descriptions[i]);
        }
    ...
    public void testSearchingBase() throws Exception {
        ...
        PenroseSearchResults results = new PenroseSearchResults();
        session.search("cn=def,ou=Groups,dc=Example,dc=com", "(objectClass=*)", sc, results);
    ...
    public void testSearchingNonExistentBase() throws Exception {
        ...
        sc.setScope(PenroseSearchControls.SCOPE_BASE);
        PenroseSearchResults results = new PenroseSearchResults();
        session.search("cn=jkl,ou=Groups,dc=Example,dc=com", "(objectClass=*)", sc, results);
    ...
    public void testSearchingOneLevelWithFilter() throws Exception {
        ...
        sc.setScope(PenroseSearchControls.SCOPE_ONE);
        PenroseSearchResults results = new PenroseSearchResults();
        session.search("ou=Groups,dc=Example,dc=com", "(cn=*b*)", sc, results);
    ...
    public void testSearchingOneLevelWithNonExistentFilter() throws Exception {
        ...
        sc.setScope(PenroseSearchControls.SCOPE_ONE);
        PenroseSearchResults results = new PenroseSearchResults();
        session.search("ou=Groups,dc=Example,dc=com", "(cn=*f*)", sc, results);
