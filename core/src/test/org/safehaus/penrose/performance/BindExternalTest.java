 ...
 */
public class BindExternalTest extends TestCase {

    public void testBindRate() throws Exception {
        ...
        for (int i=0; i<count; i++) {
            ...
            env.put(Context.SECURITY_PRINCIPAL, "uid=jstockton,ou=Users,dc=JDBC,dc=Example,dc=com");
            env.put(Context.SECURITY_CREDENTIALS, "j5t0ckt0n");
