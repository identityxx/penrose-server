...
"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -classpath "%LOCALCLASSPATH%" -Djava.ext.dirs="%LOCALLIBPATH%" -Dpenrose.home="%PENROSE_CLIENT_HOME%" -Dorg.safehaus.penrose.management.home="%PENROSE_CLIENT_HOME%\services\JMX" org.safehaus.penrose.source.SourceClient %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
