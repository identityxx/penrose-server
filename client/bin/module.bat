...
"%_JAVACMD%" %VD_SERVER_OPTS% -Djava.ext.dirs="%LOCALLIBPATH%" -Djava.library.path="%LOCALLIBPATH%" -Dorg.safehaus.penrose.client.home="%PENROSE_CLIENT_HOME%" org.safehaus.penrose.module.ModuleManagerClient %PENROSE_CMD_LINE_ARGS%
goto end
