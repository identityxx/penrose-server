package org.safehaus.penrose.ldap.client;
 ...
 */
public class LDAPSyncClient {

    PenroseClient client;

    public LDAPSyncClient(
            String serverType,
            String protocol,
            String hostname,
            int port,
    ...
    public static void main(String args[]) throws Exception {
        ...
        Getopt getopt = new Getopt("LDAPSyncClient", args, "-:?dvt:h:p:r:P:D:w:", longopts);
        ...
        try {
            LDAPSyncClient client = new LDAPSyncClient(
                    serverType,
                    protocol,
                    hostname,
                    portNumber,
