package org.safehaus.penrose.activeDirectory.client;
...
public class ADSyncClient {
    ...
    public static void showUsage() {
        System.out.println("Usage: org.safehaus.penrose.activeDirectory.client.ADSyncClient [OPTION]... <command> [arguments]...");
        System.out.println();
