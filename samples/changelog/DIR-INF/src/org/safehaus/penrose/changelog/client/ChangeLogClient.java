package org.safehaus.penrose.changelog.client;
...
public class ChangeLogClient {
    ...
    public static void showUsage() {
        System.out.println("Usage: org.safehaus.penrose.changelog.client.ChangeLogClient [OPTION]... <command> [arguments]...");
        System.out.println();
        ...
        System.out.println("  clear <partition>          Clear change log.");
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        Getopt getopt = new Getopt("ChangeLogClient", args, "-:?dvt:h:p:r:P:D:w:", longopts);
