package org.safehaus.penrose.jdbc.client;
 ...
 */
public class JDBCSyncClient {

    PenroseClient client;

    public JDBCSyncClient(
            String serverType,
            String protocol,
            String hostname,
            int port,
    ...
    public static void showUsage() {
        System.out.println("Usage: org.safehaus.penrose.jdbc.client.JDBCSyncClient [OPTION]... <command> [arguments]...");
        System.out.println();
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            JDBCSyncClient client = new JDBCSyncClient(
                    serverType,
                    protocol,
                    hostname,
                    portNumber,
