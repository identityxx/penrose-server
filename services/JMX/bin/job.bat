...
"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -classpath "%LOCALCLASSPATH%" -Djava.ext.dirs="%LOCALLIBPATH%" -Dpenrose.home="%PENROSE_HOME%" -Dorg.safehaus.penrose.management.home="%PENROSE_HOME%\services\JMX" org.safehaus.penrose.management.JobClient %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
