...
public class ConnectionClient implements ConnectionServiceMBean {
    ...
    public static String getObjectName(String partitionName, String connectionName) {
    ...
    public static void showUsage() {
        System.out.println("Usage: org.safehaus.penrose.management.ConnectionClient [OPTION]... <COMMAND>");
        System.out.println();
