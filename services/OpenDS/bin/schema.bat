...
set LOCALLIBPATH=%LOCALLIBPATH%;%PENROSE_HOME%\services\OpenDS\SERVICE-INF\lib

"%_JAVACMD%" %PENROSE_DEBUG_OPTS% %PENROSE_OPTS% -Djava.ext.dirs="%LOCALLIBPATH%" -Djava.library.path="%LOCALLIBPATH%" -Dpenrose.home="%PENROSE_HOME%" org.safehaus.penrose.opends.OpenDSSchemaConverter %PENROSE_ARGS% %PENROSE_CMD_LINE_ARGS%
goto end
